 ...
 */
public class EncryptedTeraSort extends Configured implements Tool {
  private static final Log LOG = LogFactory.getLog(EncryptedTeraSort.class);
  ...
  public int run(String[] args) throws Exception {
   ...
   TeraEncryptedInputFormat.setInputPaths(job, inputDir);
    FileOutputFormat.setOutputPath(job, outputDir);
    job.setJobName("TeraSort");
    job.setJarByClass(EncryptedTeraSort.class);
    ...
    if (useSimplePartitioner) {
      ...
      Path partitionFile = new Path(outputDir, 
                                    TeraEncryptedInputFormat.PARTITION_FILENAME);
      URI partitionUri = new URI(partitionFile.toString() +
                                 "#" + TeraEncryptedInputFormat.PARTITION_FILENAME);
      TeraEncryptedInputFormat.writePartitionFile(job, partitionFile);
  ...
  public static void main(String[] args) throws Exception {
    int res = ToolRunner.run(new Configuration(), new EncryptedTeraSort(), args);
    System.exit(res);
  }
