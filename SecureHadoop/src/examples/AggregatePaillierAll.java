 ...
 *
 */
public class AggregatePaillierAll extends Configured implements Tool{

	@Override
	public int run(String[] args) throws Exception {
		Configuration conf = this.getConf();
		Job job = new Job(conf); 
		job.setJobName("aggregate paillier, sum all"); 
		job.setJarByClass(AggregatePaillierAll.class);
	...
	static class AggregatePaillierMapper extends Mapper<BytesWritable, BytesWritable, BytesWritable, BytesWritable>{						
		...
		public void map(BytesWritable key, BytesWritable value, Context context)
			...
			for (int i=0; i<16; i++) fixedIv[i] = 0; 
			
			context.write(new BytesWritable(fixedIv), new BytesWritable(
					encryptedRev));
		}
	...
	public static void main(String[] args) throws Exception{
		ToolRunner.run(new AggregatePaillierAll(), args); 
	}
}
