...
/**
 * Same as the original TeraInputFormat,except:
 * + key = OPE ciphertext, 20 bytes //configurable
 * + value = 16 bytes IV + 96 bytes (6-block) of AES ciphertext 
 */
public class TeraEncryptedInputFormat extends FileInputFormat<Text,Text> {
  ...
  public static int VALUE_LENGTH = 112;
  static int RECORD_LENGTH = KEY_LENGTH + VALUE_LENGTH;
