 ...
 *
 */
public class WordcountDecryptor extends Configured implements Tool{
	@Override
	public int run(String[] arg0) throws Exception {
		...
		job.setJarByClass(WordcountDecryptor.class); 
	...
	public static void main(String[] args) throws Exception{
		ToolRunner.run(new WordcountDecryptor(), args); 
	}
}

class DetDecryptorMapper extends Mapper<Ciphertext, LongWritable, Text, LongWritable>{
	private Det crypto; 
